...
namespace Graph_lib 
{
	...
	{
	public:
		Window(int w, int h, const char* title);			// let the system pick the location
		Window(Point xy, int w, int h, const char* title);	// top left corner in xy
		virtual ~Window() { }
		...
		void set_label(const char* title) { label(title); }

...
std::string* FileQuery::cleanupFile(string pFilename)
{
...
void FileQuery::listAllWordsStartingWith(char c)
{
	stringstream ss;
	for (auto p : mWordOccurrence)
	{
...
void FileQuery::listAllWordsOfSize(int pSize)
{
	stringstream ss;
	for (auto p : mWordOccurrence)
	{

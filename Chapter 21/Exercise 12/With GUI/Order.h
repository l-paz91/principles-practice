...
namespace OrderHelpers
{
	...
	template<typename Container>
	double getValueOfOrders(const Container& pCont)
	{
		double d = 0.0;
		for (Order o : pCont)
		{
	...
	inline bool searchByName(string pSearchValue, const Order& o1)
	{
		size_t found = o1.getName().find(pSearchValue);
